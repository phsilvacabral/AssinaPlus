...
<body>
    ...
    <section id="login-cadastro">
        ...
        <div id="buttons">
            ...
            <div id="button-cadastro">Criar Conta</div>
        </div>
    ...
    <div id="loginModal" class="modal hidden">
        <div class="modal-header">
            ...
            <h2 class="title-modal">Acesso ao Sistema</h2>
        ...
        <div class="modal-body">
            <form action="/../../../../Assina+/Controller/CadastroController.php?action=validarCadastro" method="POST">
                ...
                <label for="usuario">Nome de Usuário 
                    <input type="text" placeholder="nome_usuário" required>
                </label>
                ...
                <label for="confrimarSenha">Confirmar senha
                ...
                <label for="tipoUsuario" class="label-select">Tipo de Usuário:
                    <select name="tipoUusuário" id="tipoUsuario">
